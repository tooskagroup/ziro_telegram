...
.method public static handleDumpFiles(Landroid/app/Activity;)V
    ...
    sget-object v6, Lorg/telegram/messenger/BuildVars;->HOCKEY_APP_HASH_DEBUG:Ljava/lang/String;

    :goto_1
    invoke-static {p0, v6, v1, v5}, Lorg/telegram/messenger/NativeCrashManager;->uploadDumpAndLog(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 29
    :cond_1
    sget-object v6, Lorg/telegram/messenger/BuildVars;->HOCKEY_APP_HASH:Ljava/lang/String;

    goto :goto_1

    .line 32
    .end local v1    # "dumpFilename":Ljava/lang/String;
    .end local v5    # "logFilename":Ljava/lang/String;
    :cond_2
    return-void
.end method
