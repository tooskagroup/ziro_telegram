.class public Lorg/telegram/messenger/volley/toolbox/HttpClientStack;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/telegram/messenger/volley/toolbox/HttpClientStack$HttpPatch;
    }
.end annotation
...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    .line 56
    iput-object p1, p0, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
...
.method static createHttpRequest(Lorg/telegram/messenger/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 96
    .local p0, "request":Lorg/telegram/messenger/volley/Request;, "Lorg/telegram/messenger/volley/Request<*>;"
    .local p1, "additionalHeaders":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    invoke-virtual {p0}, Lorg/telegram/messenger/volley/Request;->getMethod()I
    ...
    .line 101
    :pswitch_0
    invoke-virtual {p0}, Lorg/telegram/messenger/volley/Request;->getPostBody()[B
    ...
    invoke-virtual {p0}, Lorg/telegram/messenger/volley/Request;->getPostBodyContentType()Ljava/lang/String;
    ...
    .line 120
    invoke-static {v3, p0}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lorg/telegram/messenger/volley/Request;)V
    ...
    .line 126
    invoke-static {v4, p0}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lorg/telegram/messenger/volley/Request;)V
    ...
    .line 136
    :pswitch_8
    new-instance v1, Lorg/telegram/messenger/volley/toolbox/HttpClientStack$HttpPatch;

    invoke-virtual {p0}, Lorg/telegram/messenger/volley/Request;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct {v1, v5}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack$HttpPatch;-><init>(Ljava/lang/String;)V

    .line 137
    .local v1, "patchRequest":Lorg/telegram/messenger/volley/toolbox/HttpClientStack$HttpPatch;
    const-string/jumbo v5, "Content-Type"
    ...
    invoke-virtual {v1, v5, v6}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack$HttpPatch;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    .line 138
    invoke-static {v1, p0}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lorg/telegram/messenger/volley/Request;)V
...
.method private static setEntityIfNonEmptyBody(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lorg/telegram/messenger/volley/Request;)V
    .locals 2
...
.method public performRequest(Lorg/telegram/messenger/volley/Request;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    ...
    invoke-static {p1, p2}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->createHttpRequest(Lorg/telegram/messenger/volley/Request;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v1

    .line 78
    .local v1, "httpRequest":Lorg/apache/http/client/methods/HttpUriRequest;
    invoke-static {v1, p2}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 79
    invoke-virtual {p1}, Lorg/telegram/messenger/volley/Request;->getHeaders()Ljava/util/Map;

    move-result-object v3

    invoke-static {v1, v3}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->addHeaders(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 80
    invoke-virtual {p0, v1}, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->onPrepareRequest(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    .line 87
    iget-object v3, p0, Lorg/telegram/messenger/volley/toolbox/HttpClientStack;->mClient:Lorg/apache/http/client/HttpClient;
