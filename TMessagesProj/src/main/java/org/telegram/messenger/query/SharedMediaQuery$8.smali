...
.method public run()V
    ...
    .line 438
    .local v12, "state2":Lorg/telegram/SQLite/SQLitePreparedStatement;
    iget-object v1, p0, Lorg/telegram/messenger/query/SharedMediaQuery$8;->val$messages:Ljava/util/ArrayList;
    ...
    invoke-static {v9}, Lorg/telegram/messenger/query/SharedMediaQuery;->canAddMessageToMedia(Lorg/telegram/tgnet/TLRPC$Message;)Z
    ...
    .line 441
    iget v1, v9, Lorg/telegram/tgnet/TLRPC$Message;->id:I

    int-to-long v10, v1

    .line 442
    .local v10, "messageId":J
    iget-object v1, v9, Lorg/telegram/tgnet/TLRPC$Message;->to_id:Lorg/telegram/tgnet/TLRPC$Peer;
    ...
    invoke-virtual {v9}, Lorg/telegram/tgnet/TLRPC$Message;->getObjectSize()I
    ...
    invoke-virtual {v9, v0}, Lorg/telegram/tgnet/TLRPC$Message;->serializeToStream(Lorg/telegram/tgnet/AbstractSerializedData;)V

    .line 449
    const/4 v1, 0x1

    invoke-virtual {v12, v1, v10, v11}, Lorg/telegram/SQLite/SQLitePreparedStatement;->bindLong(IJ)V
    ...
    invoke-virtual {v12, v1, v2, v3}, Lorg/telegram/SQLite/SQLitePreparedStatement;->bindLong(IJ)V

    .line 451
    const/4 v1, 0x3

    iget v2, v9, Lorg/telegram/tgnet/TLRPC$Message;->date:I

    invoke-virtual {v12, v1, v2}, Lorg/telegram/SQLite/SQLitePreparedStatement;->bindInteger(II)V
    ...
    invoke-virtual {v12, v1, v0}, Lorg/telegram/SQLite/SQLitePreparedStatement;->bindByteBuffer(ILorg/telegram/tgnet/NativeByteBuffer;)V
    ...
    .end local v12    # "state2":Lorg/telegram/SQLite/SQLitePreparedStatement;
    :catch_0
    move-exception v7
    ...
    .restart local v12    # "state2":Lorg/telegram/SQLite/SQLitePreparedStatement;
    :cond_4
    :try_start_1
